        ...
        if name == '':
            if args.dataset == 'imagenet':
                if args.nclass == 10:
                    ...
                    name = f'imagenet_100/kernel{args.kernel_type}_ipc{args.ipc}_factor{args.factor}_il{args.il}'
            else:
...
def test_data(args,
    ...
    for model_fn in model_fn_ls:
        ...
        for _ in range(repeat):
            model = model_fn(args, args.net_type, args.depth, args.nclass, logger=logger)
