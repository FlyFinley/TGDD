...
parser.add_argument('--alpha', default=1.0, type=float, help='loss ratio')
parser.add_argument('--epoch_interval', default=7, type=int, help='model epoch interval between middle and final model')
parser.add_argument('--pretrain_epochs', default=60, type=int, help='number of pre-training epochs')
